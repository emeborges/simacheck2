    ...
    */
    return (
        <>
            ...
            <Header page={'home'} />
            <Flex p={{base: '5rem 0.5rem', lg:'10rem 0rem'}} justify={'center'} align={'center'} >
            ...
            <Box bg={'linear-gradient(to top, #121214 50%, #F5F6FA 50%)'} w={'100%'}>
                <Box p={'0rem 1rem'} maxW={'1300px'} margin={'0 auto'} borderRadius={'15px'}>
                    <Image borderRadius={'15px'} src={'https://s3.sa-east-1.amazonaws.com/simacheck.staticimages.prod/Imagens+simacheck2.0/SimaCapa.png'} />
                </Box>
            </Box>
            ...
            <Box p={'3rem 0rem'} bg={'#121214'} w={'100%'} color={'#F5F6FA'}>
                <Box maxW={'1300px'} margin={'0 auto'}>
                    <Box w={'60%'} m={'0 auto'} textAlign={'center'}>
                        ...
                        <Text p={'0.5rem'}>As melhores ferramentas para o seu jogo você encontra aqui!</Text>
                        <Text>Conheça-as agora!</Text>
                    </Box>
                    <Flex
                        direction={'column'}
                        ...
                        p={'2rem 0rem'}
                    >
                        <Box w={{base:'98%', md:'80%'}} margin={'0 auto'} display={'grid'} gridTemplateColumns={'repeat(4,1fr)'}>
                            <Box
                                fontSize={{base:'90%', md:'18px'}}
                                p={'1rem 0'}
                                border={'1px solid #323238'}
                                background={conteinerNum === 1 ? 'rgba(245,246,250,0.1)' : 'none'}
                                textAlign={'center'}
                                cursor={'pointer'}
                                textDecoration={conteinerNum === 1 ? 'underline' : 'none'}
                            ...
                            <Box
                                ...
                                p={'1rem 0'}
                                border={'1px solid #323238'}
                                background={conteinerNum === 2 ? 'rgba(245,246,250,0.1)' : 'none'}
                                textAlign={'center'}
                                cursor={'pointer'}
                                textDecoration={conteinerNum === 2 ? 'underline' : 'none'}
                                textDecorationColor={'#BA1813'}
                            ...
                            <Box
                                ...
                                p={'1rem 0'}
                                border={'1px solid #323238'}
                                background={conteinerNum === 3 ? 'rgba(245,246,250,0.1)' : 'none'}
                                textAlign={'center'}
                                cursor={'pointer'}
                                textDecoration={conteinerNum === 3 ? 'underline' : 'none'}
                                textDecorationColor={'#BA1813'}
                                fontWeight={conteinerNum === 3 ? '700' : '400'}
                                onClick={() => selectConteiner(3)} className={conteinerNum == 3 ? 'btns ativo' : 'btns'}
                            >
                                SimaTimer
                            </Box>
                            <Box
                                ...
                                p={'1rem 0'}
                                border={'1px solid #323238'}
                                background={conteinerNum === 4 ? 'rgba(245,246,250,0.1)' : 'none'}
                                textAlign={'center'}
                                cursor={'pointer'}
                                borderTopRightRadius={'5px'}
                                textDecoration={conteinerNum === 4 ? 'underline' : 'none'}
                                textDecorationColor={'#BA1813'}
                                fontWeight={conteinerNum === 4 ? '700' : '400'}
                                onClick={() => selectConteiner(4)} className={conteinerNum == 4 ? 'btns ativo' : 'btns'}
                            >
                                SimaLibrary
                            </Box>
                        </Box>
            ...
            <Flex maxW={'1300px'} margin={'0 auto'} justifyContent={'space-between'} alignContent={'center'} p={'1rem 0rem'} flexWrap={'wrap'}>
                <Flex textAlign={'center'} flexDir={'column'} align={'center'}  w={{base: '100%', md: '45%'}} p={'1rem 0.5rem'}>
                    <Heading as='h1'>Quem somos?</Heading>
                    <Heading as='h2' fontSize={'140%'}>SimaGuild ou SimaEquipe?!</Heading>
                    <Text p={'0.5rem 0rem'}>Chegamos aqui não tão só, tudo aqui foi na base da raça e do KS em hunt!</Text>

                    <Button mt={'1rem'} w={'20rem'} bg={'#121214'} color={'#F5F6FA'} _hover={{ color: '#121214', bg: '#F5F6FA', border: '1px solid #121214' }}>
                        Conheça nossa equipe!
                    </Button>
                </Flex>
                <Flex textAlign={'center'} flexDir={'column'} align={'center'} w={{base: '100%', md: '45%'}}  p={'1rem 0.5rem'}>
                    <Heading as='h1'>Tá com dúvida?</Heading>
                    <Heading as='h2' fontSize={'140%'}>Como funciona, o que é DLD, quando aparece?!</Heading>
                    <Text p={'0.5rem 0rem'}>Já que as informações não são poucas, fizemos um guia ideal para você entender todos os relatórios</Text>
